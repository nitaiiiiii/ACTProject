...
class SubscriptionActivity: BaseActivity<ActivitySubscriptionBinding,SubscriptionView,SubscriptionViewModel>(),SubscriptionView {
    ...
    private fun adapterClick(){
        subscriptionAdapter?.subscriptionClick(object:SubscriptionViewPagerAdapter.SubscriptionClick{
