...
class OnBoardingScreensFragment : BaseFragment<FragmentOnBoardingScreensBinding,OnBoardingScreenView,OnBoardingScreensViewModel>(),OnBoardingScreenView {
    ...
    override fun initViews(savedInstanceState: Bundle?) {
        ...
        Glide.with(mViewDataBinding?.imgOnBoardScreenImage?.context!!).load(currentData.image).into(mViewDataBinding?.imgOnBoardScreenImage!!)
    }

    private fun addData() {
        screenData.add(OnBoardingModel("Base Architecture","One","Description one",R.drawable.onboarding1))
        screenData.add(OnBoardingModel("Base Architecture","Two","Description Two",R.drawable.onboarding2))
        screenData.add(OnBoardingModel("Base Architecture","Three","Description Three",R.drawable.onboarding3))
    }
