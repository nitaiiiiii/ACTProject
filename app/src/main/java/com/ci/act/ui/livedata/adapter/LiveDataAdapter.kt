...
class LiveDataAdapter:ListAdapter<LiveDataModel,LiveDataAdapter.LiveDataViewHolder>(LiveDataModelDiffUtils()) {

   inner class LiveDataViewHolder(private val myItemView:View):RecyclerView.ViewHolder(myItemView){
